...
document.getElementById("test2").innerHTML="To prove the above and give an idea of how often the prisoners succeed, I have made a simulation of 100 prisoners going into a room and opening the boxes by the rule described above. To make it simpler to code (I'm a beginner), I numbered the prisoners and the boxes 0 to 99, instead of 1 to 100. When the run button is clicked, it will calculate whether all the 100 prisoners find their numbers in less than 50 tries and live, or just one has failed, making them all fail. If you scroll down afterwards, you can see more details."
